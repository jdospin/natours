...
function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamRvc3BpbiIsImEiOiJjanZvM2ZuejMwNnd6NGFvNHUzcTY3a2xuIn0.mHjASieo7rVyFD74p7QFDg';
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51Id4QlCgjPAsaIeh0M9xpWsDnCuVtNsHVU6mlu0BSyGLg7I0DBnLYMxwOf4rFtMRSpFA5Dq4SHeXfM6DXN0T9IkP00mkarj1oz'); // get checkout session from API
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateUserData)(form, 'User data');
  });
}
